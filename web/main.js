...
(function(){
  ...
  ldResize = function(opt){
    var host, root, dim, ns, nr, ng, nb, mouse, this$ = this;
    opt == null && (opt = {});
    host = !opt.host
      ? opt.root
      : opt.host;
    ...
    mouse = {
      ...
      move: function(e){
        var ref$, cx, cy, nx, ny, box, dx, dy, d, pt, pc, pv, mc, p2, v, len, a, p2p, na, p1, p1p, v2, len2, cp;
  ...
  ldResize.prototype = import$(Object.create(Object.prototype), {
    ...
    attach: function(n, plus){
      ...
      if (this.tgt.length > 1) {
        ...
        this.tgt[0]._mi = mi;
        this.dim.mo = this.tgt[0]._mo = _(this.tgt[0].parentNode);
      }
      import$(this.dim, at);
      import$(this.dim, box);
    ...
    detach: function(){},
    pts: function(){
      var z, ref$, cx, cy, a, b, c, d, e, f, mc, p, pt, pc, pv;
      z = this.dim;
      ...
      pt = [
        ...
        return import$(p, it).matrixTransform(z.mo.multiply(mc));
      });
      p.x = z.x + z.w * 0.5;
      p.y = z.y + z.h * 0.5;
    ...
    render: function(){
      var z, ref$, ng, nb, ns, nr, a, b, c, d, e, f, pt, pc, pv, s, h, r, i$, y, j$, x, mat, this$ = this;
      z = this.dim;
      ...
      for (i$ = 0; i$ <= 1; ++i$) {
        ...
        for (j$ = 0; j$ <= 1; ++j$) {
          x = j$;
          [['x', x * pv[0].x + y * pv[1].x + pt[0].x - s * r + s * r * x], ['y', x * pv[0].y + y * pv[1].y + pt[0].y - s * r + s * r * y], ['width', s * r], ['height', s * r]].map(fn1$);
        }
      }
